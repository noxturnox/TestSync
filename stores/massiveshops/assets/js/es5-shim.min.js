...
;(function(e, t) {
        ...
        bind: function bind(e) {
            ...
            var a = function() {
                if (this instanceof i) {
                    var a = t.apply(this, p.call(n, f.call(arguments)))
                    if (r(a) === a) {
                        return a
                    }
                    return this
    ...
    if (t.reduce) {
        L =
            typeof t.reduce.call('es5', function(e, t, r, n) {
                return n
            }) === 'object'
    }
    M(
    ...
    if (t.reduceRight) {
        X =
            typeof t.reduceRight.call('es5', function(e, t, r, n) {
                return n
            }) === 'object'
    }
    M(
    ...
    var le = oe.length
    var ue = function isArguments(e) {
        return C(e) === '[object Arguments]'
    }
    var fe = function isArguments(e) {
        return (
            e !== null &&
            typeof e === 'object' &&
    ...
    var ye =
        ...
        new Date(he).toISOString().indexOf(ge) === -1
    var de =
        Date.prototype.toISOString &&
    ...
    M(
        Date.prototype,
        {
            toISOString: function toISOString() {
                ...
                n =
                    (n < 0 ? '-' : n > 9999 ? '+' : '') +
                    P('00000' + Math.abs(n), 0 <= n && n <= 9999 ? -4 : -6)
                t = e.length
                while (t--) {
                    r = e[t]
                    if (r < 10) {
                ...
                return (
                    ...
                    f.call(e, 2).join(':') +
                    '.' +
                    P('000' + this.getUTCMilliseconds(), -3) +
                    'Z'
                )
            },
        },
    ...
    var we = (function() {
        try {
            return (
                ...
                new Date(he).toJSON().indexOf(ge) !== -1 &&
    ...
    if (Te || be || !me) {
        Date = (function(e) {
            var t = function Date(r, n, i, o, l, u, f) {
            ...
            var i = function dayFromMonth(e, t) {
                ...
                return (
                    n[t] +
                    Math.floor((e - 1969 + r) / 4) -
                    Math.floor((e - 1901 + r) / 100) +
                    Math.floor((e - 1601 + r) / 400) +
                    365 * (e - 1970)
                )
            }
            ...
            M(t, { now: e.now, UTC: e.UTC }, true)
            t.prototype = e.prototype
            M(t.prototype, { constructor: t }, true)
            ...
            toFixed: function toFixed(e) {
                ...
                if (r > 1e-21) {
                    ...
                    if (o > 0) {
                        ...
                        i =
                            Oe.numToString() +
                            P('0.00000000000000000000', 2, 2 + t)
                    }
                }
                if (t > 0) {
                    s = i.length
                    if (s <= t) {
                        i = n + P('0.0000000000000000000', 0, t - s + 2) + i
                    } else {
                        i = n + P(i, 0, s - t) + '.' + P(i, s - t)
                    }
                } else {
                    i = n + i
                }
    ...
    var ke = '\u200b'
    var Ne = '[' + De + ']'
    var Fe = new RegExp('^' + Ne + Ne + '*')
    var Me = new RegExp(Ne + Ne + '*$')
    var Re = o.trim && (De.trim() || !ke.trim())
    M(
        o,
        {
            trim: function trim() {
