;(function(require) {
    ...
    ;(function() {
        ...
        var config = {
            ...
            deps: ['Magento_Checkout/js/checkout-loader'],
        }
        ...
        var config = {
            map: {
                '*': {
                    ...
                    braintreePayPalMinicart:
                        'Magento_Braintree/js/button/braintree-paypal-minicart',
                    transparent: 'Magento_Payment/transparent',
                },
            },
        }
    ...
    ;(function() {
        ...
        var config = {
            ...
            paths: {
                'owlcarousel/minjs':
                    'Plazathemes_Loadjs/js/owl-carousel/owl.carousel.min',
            },
        }
